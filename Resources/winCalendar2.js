...
exports.createWindow = function(__userData){
		...
		calView.addEventListener('click', function(e) {
			...
			if (e.source.objectName == "calendarDayView"
				...
				if (target.dayImage != null) {
					...
					var calendarPhotoWin = win.createCalendarPhotoWindow(_userData, target.articleData);
					win.openTabWindow(calendarPhotoWin, {animated:true});
